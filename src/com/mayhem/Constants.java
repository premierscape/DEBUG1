...
public class Constants {
	...
	public final static String[] STAFF_MEMBERS = { 
		"", "brandon", "cicilovinitt", "kaos", "saint plague"
	};
	 ...
	 * 
	 */
	public static final String VOTE_LINK = "http://premierscape.net/vote/";
	public static final String STORE_LINK = "http://premierscape.net/store/";
	public static final String FORUM_LINK = "http://premierscape.net";
	public static final String HISCORE_LINK = "";
	public static final String UPDATE_LINK = "http://premierscape.net/";
	public static final String RS_ADV = "https://www.rune-server.ee/runescape-development/rs2-server/advertise/650918-GrandPremier-your-1-custom-old-school-experience-updated-daily-gambling-24-7-a.html";
