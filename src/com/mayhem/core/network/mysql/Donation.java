		...
		try {
			...
			while (rs.next()) {
				...
				case 18: // 100 GrandPremierBucks
					...
					player.getClient().queueOutgoingPacket(new SendMessage("Thank you for supporting PremierScape."));
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
				break;
				case 19: // 300 PremierScape bucks
				...
				break;
				case 20: // 500 PremierScape bucks
					...
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
				break;
				case 21: // 1000 PremierScape bucks
					...
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
				break;
				case 22: // 2500 PremierScape bucks
					...
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
				break;
				case 23: // 5000 PremierScape bucks
					...
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
				break;
				case 24: // 10,000 PremierScape bucks
					...
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
				break;
				case 25: // 20,000 PremierScape bucks
				...
				case 50: // mystery box x10
					...
					World.sendGlobalMessage("</col>[ @dre@PremierScape </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just Donated to PremierScape! Thank you for your contribution! ");
						...
						RankHandler.upgrade(player);
						player.setMember(true);
						player.getClient().queueOutgoingPacket(new SendMessage("Thank you for supporting PremierScape. Your donation has been sent to your bank."));
					}
				break;
