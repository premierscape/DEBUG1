...
public class WeightedChance<T> implements WeightedObject<T> {
	...
	public static final double COMMON = 20;
	public static final double UNCOMMON = 10;
	public static final double RARE = 3;
	public static final double VERY_RARE = 1.5;
	public static final double LEGENDARY = 1;//0.50% Chance?
