 ...
 *
 */
public class MiniRaid2WaitingRoomController extends Controller {
	...
	public void tick(Player p) {
		p.getClient().queueOutgoingPacket(new SendString("Next Raid in: " + Utility.getFormattedTime(MiniRaid2.getMinutesTillDepart())  + "", 31120));
		p.getClient().queueOutgoingPacket(new SendString("Players Ready: " + MiniRaid2.getPlayersReady(), 31121));
