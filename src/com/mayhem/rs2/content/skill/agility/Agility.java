...
public enum Agility {
	...
	public static void declare() {
		try {
			bufferedReader = new BufferedReader(new FileReader("./data/def/skills/agility.json"));
			Obstacle[] loaded = new Gson().fromJson(bufferedReader, Obstacle[].class);
...
//		 .build());
	...
	public static double TICKET_EXPERIENCE = 5.0;
