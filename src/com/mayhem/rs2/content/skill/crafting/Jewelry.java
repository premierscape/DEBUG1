...
public enum Jewelry {
	...
	/* Rings */
	GOLD_RING(1635, 1592, 5, 15, 1592, 2357),
	SAPPHIRE_RING(1637, 1592, 20, 40, 1592, 2357, 1607),
	EMERALD_RING(1639, 1592, 27, 55, 1592, 2357, 1605),
	RUBY_RING(1641, 1592, 34, 70, 1592, 2357, 1603),
	DIAMOND_RING(1643, 1592, 43, 85, 1592, 2357, 1601),
	DRAGONSTONE_RING(1645, 1592, 55, 100, 1592, 2357, 1615),
	ONYX_RING(6575, 1592, 67, 85, 1592, 2357, 6573),
	...
	/* Amulet */
	GOLD_AMULET(1673, 1595, 8, 30, 1595, 2357),
	...
	private Jewelry(int rewardId, int reward2Id, int levelRequired, double experienceGain, int...materialsRequired) {
		this.reward = new Item(rewardId);
		this.reward2 = new Item(reward2Id);
