...
public class LoyaltyShop {
	...
	public static enum TitleButton {
		 ...
		 * Colors
		 */
		RED(215225, PlayerTitle.create("null", 0xC22323, false), 50),//done
		GREEN(215233, PlayerTitle.create("null", 0x23C223, false), 50),
		BLUE(215241, PlayerTitle.create("null", 0x2AA4C9, false), 50),//done
		YELLOW(215249, PlayerTitle.create("null", 0xC9BC28, false), 50),
		ORANGE(216001, PlayerTitle.create("null", 0xB0720E, false), 50),
		PURPLE(216009, PlayerTitle.create("null", 0xC931E8, false), 100),
		PINK(216017, PlayerTitle.create("null", 0xF52CD7, false), 50),//done
		WHITE(216025, PlayerTitle.create("null", 0xFFFFFF, false), 50);
		...
		if (!player.unlockedTitles.contains(button.getTitle())) {
			if (button.getPrice() instanceof Integer) {
				if (player.getCredits() < Integer.parseInt(String.valueOf(button.getPrice()))) {
					player.send(new SendMessage("<col=128>You do not have enough GrandPremier Bucks to buy this."));
					return true;
				}
			}
