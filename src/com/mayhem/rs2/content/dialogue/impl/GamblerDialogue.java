...
public class GamblerDialogue extends Dialogue {
    ...
    public boolean clickButton(int id) {
       ...
       case DialogueConstants.OPTIONS_4_1:
    	   DialogueManager.sendNpcChat(player, 1011, Emotion.HAPPY_TALK, "The net total of all GrandPremier gambling is: " + Utility.format(Gambling.MONEY_TRACKER) + " gp.");
    	   break;
    ...
    public void execute() {
       ...
       case 0:
    	   DialogueManager.sendNpcChat(player, 1011, Emotion.HAPPY_TALK, "Hello " + player.getUsername() + "!", "I am in charge of all gambling done in GrandPremier.");
    	   next++;
    	   break;
