...
public class MembershipDialogue extends Dialogue {
	...
	public boolean clickButton(int id) {
		...
		case DialogueConstants.OPTIONS_5_2:
			player.send(new SendString("http://www.valius.net/community/", 12000));
			break;
	...
	public void execute() {
		...
		case 0:
			...
			break;
		case 1:
			DialogueManager.sendOption(player, "What are GrandPremier Bucks?", "Benifits of membership", "I have purchased something", "Update rank", "Nevermind");
			break;
		case 2:
			DialogueManager.sendNpcChat(player, 7042, Emotion.DEFAULT, "GrandPremier Bucks can be purchased on our online store.", "They can be used for buying items from my store ", "and many other features in game.", "Including purchasing GrandPremier Bucks in the Shops tab.");
			setNext(1);
			break;
		case 3:
