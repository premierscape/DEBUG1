...
public class TutorialNpcAreas extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, GUIDE, Emotion.HAPPY_TALK, "Hello @blu@" + player.getUsername() + "</col>, I'm the server guide!", "Would you like a tour of some areas around GrandPremier?");
			next++;
			break;
		case 1:
		...
		case 10:
			tele(3565, 3309);
			nChat(new String[] { "Here is one of the many minigames on GrandPremier.", "This minigame is a great way to make", "some starter money & get barrows armor!" });
			break;
		case 11:
			tele(3087, 3515);
		...
		case 12:
			...
			break;
		case 13:
			nChat(new String[] { "If you have any more questions please", "speak to a <img=1>Moderator for help or visit our forums at", "@blu@www.GrandPremier.net</col> and post a suggestion." });
			end();
			break;
		case 19:
			end();
