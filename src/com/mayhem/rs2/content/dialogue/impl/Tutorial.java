...
public class Tutorial extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, GUIDE, Emotion.HAPPY_TALK, "Hello @blu@" + player.getUsername() + "</col>, Welcome to GrandPremier!", "Would you like a quick tour of our home area?");
			next++;
			break;
		case 1:
		...
		case 5:
			...
			break;
		case 6:
			nChat(new String[] { "Skilling is a great place to start on GrandPremier.", "You can recieve many Experience boosting items", "RANDOMLY while skilling!" });
			break;
		case 7:
		...
		case 11:
			...
			break;
		case 12:
			nChat(new String[] { "Check out our forums (@red@www.premierscape.net</col>)", "Make sure to vote to keep the server active." });
			break;
		case 13:
