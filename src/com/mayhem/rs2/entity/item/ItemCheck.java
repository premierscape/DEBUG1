...
public class ItemCheck {
	...
	public static boolean wearingFullAncestrial(Player player) {
		int[] slots = { 0, 4, 7 };
		int[] ids = { 21018, 21021, 21024 };
		Item[] equip = player.getEquipment().getItems();
	...
	public static boolean wearingFullJusticiar(Player player) {
		int[] slots = { 0, 4, 7 };
		int[] ids = { 22326, 22327, 22328 };
		Item[] equip = player.getEquipment().getItems();
	...
	public static boolean wearingKodaiWand(Player player) {
		int[] slots = { 3 };
		int[] ids = { 21006 };
		Item[] equip = player.getEquipment().getItems();
