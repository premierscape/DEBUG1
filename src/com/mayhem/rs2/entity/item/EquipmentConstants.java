...
public class EquipmentConstants {
	...
	private static final int[] FULL_BODY_IDS = {
		20794, 22327, 14992, 14995, 14997, 13387, 10939, 10037, 20775, 20840, 21021, 10043, 10049, 20704, 
		20436, 20517, 20038, 13284, 19689, 20421,  20131, 11828, 13259, 13583, 13595, 13607, 13619, 13631,
		5000, 20199, 6322, 20240,  5008, 5553, 9924, 11854, 11832, 20096, 10370, 10386, 10378, 6129, 7399, 
		13870, 13858, 10564, 11720, 10386, 1035, 13624, 13614, 
	...
	private static final int[] FULL_HELM_IDS = { 
		13876, 13864, 20792, 22326, 14991, 14994, 14998, 13385, 10941, 13197, 13199, 20764, 10039, 10045, 10051, 20595, 20113, 20116, 20119, 20122, 20125, 13283, 10342, 13579, 20128, 13591, 13603, 13615, 13627, 20100, 10589, 6326, 5010, 4724, 1153, 1155, 1157, 1159, 1161, 1163, 1165, 2587, 2595, 2605, 
	...
	private static final int[] FULL_MASK_IDS = { 
		20792, 22326, 14991, 14994, 14998, 19687, 20838, 20773, 19639, 19647, 19643, 20439, 20708, 13283, 19699, 12417, 12371, 8464, 8466, 8468, 8470, 8472, 8474, 8476, 8478, 8480, 8482, 8484, 8486, 8488, 8490, 8492, 4745, 
	...
	public static final void declare() {
		...
		for (int i = 0; i < 20145; i++) {
			...
			if ((def1 != null) && (def2 != null)) {
				...
				if ((def2.getName() != null) && (def2.getName().contains("hood")) && (!def2.getName().contains("Robin")) || (def2.getName().contains("mask")) && (!def2.getName().contains("Black"))) {
					FULL_HELM[i] = 1;
				}
