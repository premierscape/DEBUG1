...
import com.mayhem.rs2.content.wogw.Wogw;
...
public class ClickButtonPacket extends IncomingPacket {
	...
	public void handle(Player player, StreamBuffer.InBuffer in, int opcode, int length) {
		...
		switch (buttonId) {
		case 148115:
			player.wogwOption="experience";
			player.send(new SendMessage("@red@You have chosen 2X exprience."));
			break;
		case 148116:
			player.wogwOption="pc";
			player.send(new SendMessage("@red@You have chosen bonus pc points."));
			break;
		
		case 148117:
			player.wogwOption="drops";
			player.send(new SendMessage("@red@You have chosen double drops."));
			break;
			
		case 148136:
			Wogw.donate(player, (int) player.wogwDonationAmount);
