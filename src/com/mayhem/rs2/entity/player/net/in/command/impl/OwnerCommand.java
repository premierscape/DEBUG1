		...
		case "givemod":
			...
			case "givesupport":
				if (parser.hasNext()) {
					...
					World.sendGlobalMessage("</col>[ @dre@GrandPremier </col>] @dre@" + p.determineIcon(p) + " " + Utility.formatPlayerName(p.getUsername()) + " has just been promoted to Player Support! ");
