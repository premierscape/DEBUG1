...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "brandon", "", "kaos" };
	 ...
	 * Home teleport
	 */
	public static Location HOME = new Location(1643, 3674, 0);
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("brandon") || p.getUsername().equalsIgnoreCase("") || p.getUsername().equalsIgnoreCase("cicilovinitt");
	}
	...
	public static boolean isDeveloper(Player p) {
		return p.getAttributes().get("developerkey") != null || p.getUsername().equalsIgnoreCase("") || p.getUsername().equalsIgnoreCase("brandon") || p.getUsername().equalsIgnoreCase("");
	}
