...
public class WalkToActions {
	 ...
	 */
	//public final static String[] DEFAULT_DIALOGUES = { "When you feel sad, just sing Roar - by Katy Perry!", "Thank the GrandPremier gods for this beautiful day!", "Break free of your cage and be happy!", "Porn is the key to a happy marriage.", "I'm in the mood to groove it out!", "Don't let fear hold you down.", "Just let it out, let it out.", "Make your dreams a reality.", "Be your own creator.", "Divine blesses your soul." };
	...
	public static final void finishClickNpc(Player player, int option, Mob mob) {
		...
		case 2:// NPC SECOND CLICK
			...
			case 306:// tutorial npc
				...
				} , "Server tour(Show several areas around GrandPremier)", p -> {
	...
	public static void finishObjectClick(Player player, int id, int option, int x, int y) {
		...
		case 1:
			...
			switch (id) {
			case 4005:
				player.send(new SendInterface(38_000));
				break;
