...
public class ObjectManager {
	...
	public static void declare() {
		...
		spawnWithObject(409, 3095, 3512, 0, 10, 0);//prayer Altar	
		...
		spawnWithObject(29170, 3090, 3475, 0, 10, 1);//max cape
		...
		spawnWithObject(14845, 3089, 3495, 0, 10, 2);//pvp tourny portal
		spawnWithObject(410, 1631, 3662, 0, 10, 0);//Lunar Altar
		spawnWithObject(6552, 1634, 3663, 0, 10, 0);//Ancient Altar
		spawnWithObject(409, 1638, 3663, 0, 10, 0);//prayer Altar	
		spawnWithObject(4875, 1633, 3684, 0, 10, 0);//Food stall
		spawnWithObject(4876, 1634, 3684, 0, 10, 0);//General stall
		spawnWithObject(4874, 1635, 3684, 0, 10, 0);//Crafting stall
		spawnWithObject(4877, 1636, 3684, 0, 10, 0);//Magic stall
		...
		spawnWithObject(26492, 1638, 3675, 0, 10, 0);//vote booth
		spawnWithObject(29170, 1624, 3684, 0, 10, 2);//max cape
		spawnWithObject(29171, 1625, 3684, 0, 10, 2);//max cape
		spawnWithObject(29175, 1626, 3684, 0, 10, 2);//max cape
		spawnWithObject(29172, 1627, 3684, 0, 10, 2);//max cape
		spawnWithObject(29174, 1628, 3684, 0, 10, 2);//max cape
		spawnWithObject(29173, 1629, 3684, 0, 10, 2);//max cape
		spawnWithObject(7322, 1624, 3662, 0, 10, 2);//raids portal
		spawnWithObject(14503, 1627, 3658, 0, 10, 0);
		spawnWithObject(14503, 1630, 3658, 0, 10, 0);
		...
		setClipToZero(3095, 3508, 0);//north of bank
		setClipToZero(3096, 3507, 0);
		setClipToZero(3095, 3507, 0);
		...
		setClipToZero(1638, 3674, 0);
		setClipToZero(1638, 3673, 0);
		setClipToZero(1638, 3672, 0);
		setClipToZero(1637, 3675, 0);
		setClipToZero(1636, 3675, 0);
		setClipToZero(1635, 3675, 0);
		setClipToZero(1634, 3674, 0);
		setClipToZero(1633, 3674, 0);
		setClipToZero(1637, 3675, 0);
		setClipToZero(1632, 3674, 0);
		setClipToZero(1634, 3671, 0);
		setClipToZero(1635, 3671, 0);
		setClipToZero(1636, 3671, 0);
		setClipToZero(1637, 3671, 0);
		...
		//great whatever, new home area?
				...
				setClipped(1635, 3671, 0);
				setClipped(1636, 3671, 0);
				setClipped(1637, 3671, 0);
				setClipped(1634, 3674, 0);
				setClipped(1634, 3673, 0);
				setClipped(1634, 3672, 0);
				setClipped(1637, 3675, 0);
				setClipped(1636, 3675, 0);
				setClipped(1635, 3675, 0);
				setClipped(1638, 3675, 0);
				setClipped(1638, 3672, 0);
				setClipped(1638, 3673, 0);
				setClipped(1638, 3674, 0);
				setClipToZero(1636, 3670, 0);
