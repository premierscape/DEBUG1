...
public abstract class Entity implements CombatInterface {
	...
	public boolean inMultiArea() {
		...
		int y = location.getY();
		int z = location.getZ();
		if (inArea(new Location(1671, 10098, 0), new Location(1671, 10999, 0), false)) {
			return true;
		}
		if (inArea(new Location(1667, 10089, 0), new Location(1676, 10084, 0), false)) {
			return true;
		}
		if (inArea(new Location(1671, 10094, 0), new Location(1677, 10094, 0), false)) {
			return true;
		}
